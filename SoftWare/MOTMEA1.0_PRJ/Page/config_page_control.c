...
{
//	u8 i;
//	USART_SendData(USART1,configInformation.partInformation[0].testCurrentDownLimit);
//	USART_SendData(USART1,configInformation.partInformation[0].testCurrentDownLimit >> 8);
